...
function calculateTotals(subtotal: number, shippingMethod: ShippingMethod, discount: number) {
  ...
  const shipping = shippingMethod === "express" ? 299 : (discountedSubtotal >= 2500 ? 0 : 199);
...
export default function CheckoutExperience() {
  ...
  const discount = discountCode === "WELCOME10" ? Math.round(cart.subtotal * 0.1) : 0;
  ...
  function applyDiscount() {
    ...
    if (code === "WELCOME10") { setDiscountCode(code); setDiscountMessage("WELCOME10 applied — 10% off your ritual."); }
